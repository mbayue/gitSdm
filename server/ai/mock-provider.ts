...
/**
 * Mock AI provider used when no API keys are configured.
 * Returns context-aware canned responses for each AI task type,
 * allowing the app to function end-to-end without external AI services.
 */
