...
pnpm dev:frontend  # Frontend UI on http://localhost:5173
pnpm dev:backend   # Express backend on http://localhost:3001
```
...
3. **Verify Build**: Ensure `pnpm run build` runs successfully.
